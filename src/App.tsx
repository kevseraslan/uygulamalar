                    ...
                    <div className="max-w-4xl mx-auto flex flex-col md:flex-row items-center md:items-start gap-8">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
                                Frontend gelistirici olarak modern web teknolojileriyle kullanici
                                dostu arayuzler olusturuyorum.
                            </p>
                            <ul className="flex flex-wrap gap-2">
                    ...
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <Card
                                ...
                                imageAlt="Kisisel Blog Ekran Goruntusu"
                            >
                                Gelistiriciler icin Vite ve TS tabanli blog portal.
                            </Card>
                        </div>
                    </div>
                </section>
        ...
        <>
            <div className="fixed top-4 right-4 z-50 flex gap-2">
                <button
                    ...
                    className="bg-blue-600 dark:bg-blue-500 text-white p-2 rounded-full shadow-lg hover:scale-105 transition-transform"
                >
                    {showUIKit ? "Portföy'e Dön" : "UI Kit Göster"}
                </button>
                {!showUIKit && (
                    <button
